...
public class ClearSceneController : MonoBehaviour
{
    ...
    void Start()
    {
        Debug.Log("ClearSceneController: Startが呼び出されました。");
        ...
        if (firstSelected != null)
        {
            ...
            Debug.Log($"ClearSceneController: UIの初期選択を '{firstSelected.name}' に設定しました。");
        }
        else
        {
    ...
    void Update()
    {
        ...
        {
            Debug.Log("ClearSceneController: Submitボタンが押されました。");
            OnClickReturnTitle();
        }
    }
    ...
    public void OnClickReturnTitle()
    {
        ...
        {
            Debug.Log("ClearSceneController: 既にシーン遷移中のため、処理をスキップします。");
            return;
        }

        m_isTransitioning = true; // 遷移中フラグを立てる
        Debug.Log("ClearSceneController: タイトルに戻る処理を開始します。");
        ...
        if (GameManager.instance != null)
        {
            ...
            UnityEngine.Debug.Log("ClearSceneController: タイトルシーンへフェード遷移を開始します。");
        }
        else
        {
            // GameManagerがない場合のフォールバックとして、直接シーンをロード
            UnityEngine.Debug.LogError("ClearSceneController: GameManager インスタンスが見つかりません！直接シーンをロードします。");
